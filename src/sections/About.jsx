...
const About = ({ sectionRef }) => {
  return (
    ...
    >
      ...
      <p>I’m currently in my <b>fifth semester</b> at Örebro University (Sweden), enrolled in the <b>Programme of Systems Analysis</b> (Systemvetenskapliga programmet). I have always had a strong connection to technology, with computers playing a significant role in my life from a young age.</p>
      <p>Over the past two years, my academic journey has solidified my <b>passion</b> for problem-solving and building user-centric, robust and scalable systems. I thrive in environments where complex challenges need elegant and efficient solutions. <b>My goal</b> is to leverage my skills and knowledge to create impactful solutions that not only solves real-world problems but also enhances user experiences.</p>
